...
<div class="page">
  ...
  <form method="GET" style="margin-bottom:20px;">
    <div class="filters">
      ...
      <a href="<?= BASE_URL ?>/modules/tickets/index.php" class="btn btn-ghost btn-sm">Limpiar</a>
      <a href="<?= BASE_URL ?>/modules/tickets/nuevo.php" class="btn btn-success btn-sm" style="margin-left:auto;">➕ Nuevo Ticket</a>
    </div>
  </form>
      ...
      <table>
        ...
        <?php else: ?>
          ...
          <tr>
            ...
            <td><a href="<?= BASE_URL ?>/modules/tickets/ver.php?id=<?= $t['id'] ?>" class="btn btn-ghost btn-sm">Ver</a></td>
          </tr>
          <?php endforeach; ?>
        <?php endif; ?>
        </tbody>
      ...
      <?php else: ?>
        ...
        <div class="t-card">
          <div class="t-card-header">
            <div>
              ...
              <div class="t-card-title">
                <a href="<?= BASE_URL ?>/modules/tickets/ver.php?id=<?= $t['id'] ?>" style="color:var(--text);">
          ...
          <div class="t-card-action">
            <a href="<?= BASE_URL ?>/modules/tickets/ver.php?id=<?= $t['id'] ?>" class="btn btn-ghost btn-sm btn-full">Ver ticket →</a>
          </div>
        </div>
        <?php endforeach; ?>
      <?php endif; ?>
